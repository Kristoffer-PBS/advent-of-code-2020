...
pub(crate) fn run() -> Results {
    ...
    let input: String =
        std::fs::read_to_string("input/day04.txt").expect("Could not open day04.txt");
...
pub(crate) fn report(results: &Results) {
    output::print_day(4);
    output::print_part(1, "ﳡ valid passports", &format!("{}", results.part_1));
    output::print_part(2, "ﳡ valid passports", &format!("{}", results.part_2));
